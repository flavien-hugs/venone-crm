...
Revision ID: 20e7b6cfd4bf
Revises:
Create Date: 2026-03-08 17:54:15.503852
...
def upgrade():
    ...
    with op.batch_alter_table("roles", schema=None) as batch_op:
        ...
        batch_op.create_index(
            batch_op.f("ix_roles_role_default"), ["role_default"], unique=False
        )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["vn_role_id"],
            ["roles.id"],
            name=op.f("fk_user_vn_role_id_roles"),
            ondelete="SET NULL",
        ),
        ...
        sa.UniqueConstraint(
            "vn_business_number", name=op.f("uq_user_vn_business_number")
        ),
        sa.UniqueConstraint(
            "vn_phonenumber_one", name=op.f("uq_user_vn_phonenumber_one")
        ),
    )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["vn_user_id"],
            ["user.id"],
            name=op.f("fk_houseowner_vn_user_id_user"),
            ondelete="cascade",
        ),
        ...
        sa.UniqueConstraint(
            "vn_phonenumber_one", name=op.f("uq_houseowner_vn_phonenumber_one")
        ),
    )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["vn_user_id"],
            ["user.id"],
            name=op.f("fk_percent_vn_user_id_user"),
            ondelete="CASCADE",
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["vn_user_id"],
            ["user.id"],
            name=op.f("fk_transfer_request_vn_user_id_user"),
            ondelete="CASCADE",
        ),
        sa.PrimaryKeyConstraint("id", name=op.f("pk_transfer_request")),
        sa.UniqueConstraint(
            "vn_transfer_id", name=op.f("uq_transfer_request_vn_transfer_id")
        ),
    )
    with op.batch_alter_table("transfer_request", schema=None) as batch_op:
        ...
        batch_op.create_index(
            batch_op.f("ix_transfer_request_uuid"), ["uuid"], unique=False
        )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["vn_owner_id"],
            ["houseowner.id"],
            name=op.f("fk_house_vn_owner_id_houseowner"),
        ),
        sa.ForeignKeyConstraint(
            ["vn_user_id"], ["user.id"], name=op.f("fk_house_vn_user_id_user")
        ),
    ...
    op.create_table(
        ...
        sa.Column("id", sa.Integer(), nullable=False),
        sa.ForeignKeyConstraint(
            ["vn_house_id"], ["house.id"], name=op.f("fk_tenant_vn_house_id_house")
        ),
        sa.ForeignKeyConstraint(
            ["vn_owner_id"],
            ["houseowner.id"],
            name=op.f("fk_tenant_vn_owner_id_houseowner"),
        ),
        sa.ForeignKeyConstraint(
            ["vn_user_id"], ["user.id"], name=op.f("fk_tenant_vn_user_id_user")
        ),
        sa.PrimaryKeyConstraint("id", name=op.f("pk_tenant")),
        sa.UniqueConstraint("vn_addr_email", name=op.f("uq_tenant_vn_addr_email")),
        sa.UniqueConstraint(
            "vn_phonenumber_one", name=op.f("uq_tenant_vn_phonenumber_one")
        ),
    ...
    op.create_table(
        ...
        sa.Column("id", sa.Integer(), nullable=False),
        sa.ForeignKeyConstraint(
            ["vn_house_id"], ["house.id"], name=op.f("fk_payment_vn_house_id_house")
        ),
        sa.ForeignKeyConstraint(
            ["vn_owner_id"],
            ["houseowner.id"],
            name=op.f("fk_payment_vn_owner_id_houseowner"),
        ),
        sa.ForeignKeyConstraint(
            ["vn_payee_id"], ["user.id"], name=op.f("fk_payment_vn_payee_id_user")
        ),
        sa.ForeignKeyConstraint(
            ["vn_tenant_id"], ["tenant.id"], name=op.f("fk_payment_vn_tenant_id_tenant")
        ),
        sa.PrimaryKeyConstraint("id", name=op.f("pk_payment")),
        sa.UniqueConstraint("vn_payment_id", name=op.f("uq_payment_vn_payment_id")),
        sa.UniqueConstraint(
            "vn_transaction_id", name=op.f("uq_payment_vn_transaction_id")
        ),
    )
