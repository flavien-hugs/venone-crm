...
def test_to_domain_conversion(app_context, mock_persistence_house):
    ...
    assert domain_entity.lease_end_date == mock_persistence_house.vn_house_lease_end_date
...
def test_to_persistence_conversion(app_context, mock_domain_house):
    ...
    assert persistence_dict["vn_house_lease_end_date"] == mock_domain_house.lease_end_date
