...
def test_verify_payment_with_provider_success(app_context, payment_service, mock_payment_repository, mock_payment_provider):
...
def test_verify_payment_with_provider_failed(app_context, payment_service, mock_payment_repository, mock_payment_provider):
...
def test_initiate_payment_url_success(mock_tenant, mock_get_house_service, app_context, payment_service, mock_payment_provider):
    ...
    with patch('src.core.services.payment_service.Payment'), patch('src.core.services.payment_service.db'):
...
@patch('src.core.get_house_service')
def test_initiate_payment_url_failure(mock_get_house_service, app_context, payment_service, mock_payment_provider):
